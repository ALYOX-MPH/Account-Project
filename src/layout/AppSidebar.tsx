...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Inicio",
    subItems: [{ name: "Inicio Principal", path: "/", pro: false }],
  },
  {
    name: "Contactos",  
    icon: <UserCircleIcon />,
  ...
  },
  {
    ...
    icon: <TiShoppingCart />,
    subItems: [
      { name: "Inicio Compras", path: "/Purchases", pro: false },
      { name: "Registro de Compras", path: "/Purchases/create", pro: false },
  ...
  },
  {
    ...
    icon: <TbReport />,
    subItems: [
      { name: "Contactos", path: "/RP-Contacts", pro: false },
      { name: "Inventario", path: "/RP-Inventory", pro: false },
      { name: "Compras", path: "/RP-Purchases", pro: false },
      { name: "Facturas", path: "/RP-Invoices", pro: false },
      { name: "Contabilidad", path: "/RP-Accounting", pro: false },
      { name: "Recursos Humanos", path: "/RP-HumanResources", pro: false },
      { name: "Analisis Financiero", path: "/RP-AnalisisFinances", pro: false },
    ],
  },
  {
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "Configuracion"].forEach((menuType) => {
      const items = menuType === "main" ? navItems : ConfiguracionItems;
      items.forEach((nav, index) => {
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({
                type: menuType as "main" | "Configuracion",
                index,
              });
              submenuMatched = true;
            }
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "Configuracion") => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "Configuracion") => (
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="">
              ...
              {renderMenuItems(ConfiguracionItems, "Configuracion")}
            </div>
          </div>
        </nav>
